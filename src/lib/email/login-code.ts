...
export function loginCodeEmail(to: string, code: string): EmailInput {
  return {
    to,
    subject: `${code} is your Movables sign-in code`,
  ...
  <div style="max-width:480px;margin:0 auto;padding:28px 20px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;color:#1A1A1A;">
    <div style="font-weight:800;font-size:18px;letter-spacing:-0.02em;">Movables</div>
    ...
    <div style="color:#9A9186;font-size:12px;margin-top:16px;text-align:center;">Movables · party rental bookings</div>
  </div></body></html>`,
  };
}
